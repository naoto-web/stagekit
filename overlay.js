...
(function () {
  ...
  /* ②サブ予想枠を常時確保するか（8/28・§10項86）＝非常用スイッチ。既定OFF。
     ...
     ⚠️経緯＝8/28 23:30に既定OFFへ切り替えた直後、本番で空白が再発（丸かぶり判定で枠を畳んだ瞬間に
        カメラの無い182pxが露出）＝夜の枠のカメラが 1550・362幅 のままだったため→即ロールバック。
        **8/29にカメラを 1368・544幅 へ直したとNaotoが確認したので、再び既定OFFにした。**
     ⚠️カメラの変換はシフトのたびに触られうる（8/28は日中544・夜362で食い違った）。
        空白が再発したら、ここを true にして再デプロイするのが緊急手当。 */
